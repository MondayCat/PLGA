...
def federate_train_v1(client_list, cur_arguments: ExpermentPara, cur_round,
    ...
    final_state_dict_list = aggregation_module.get_aggregation_result_v1(send_para_list,
                                                                      client_loss_list)
...
def init_set_v1(client_list,
    ...
    aggregation_module.update_weight_matrix_one(update_model_list)
...
if __name__ == "__main__":
    ...
    time_stamp = ("2020-{}-{}-{}-{}-debug-fed_persional_compress_v9_1_1".format(current_time[1], current_time[2], current_time[3],current_time[4]))
