...
from client.client import Client, \
    client_train_schedule_fedavg as client_train_schedule,\
    client_train_schedule_step
...
if __name__ == "__main__":
    ...
    time_stamp = ("2020-{}-{}-{}-{}-Release-fedavg-update-v1".format(current_time[1], current_time[2], current_time[3],
                                                                      current_time[4]))
    ...
    for epoch in range(1, cur_arguments.communication_round + 1):
        ...
        start = time.time()
        client_list = fine_tune_step(client_list,step=cur_arguments.local_fine_step)
