...
# python experiment_per_fedavg_v3.py --mode NIID --dataset_name CIFAR10 --client_num 10 --class_num_for_client 6 --use_server 1
...
from client.client import Client, client_train_schedule_perfed as client_train_schedule
...
def federate_train_v1(client_list, cur_arguments: ExpermentPara, cur_round,
    ...
    final_state_dict_list = aggregation_module.get_aggregation_result(update_model_list_cp)
...
if __name__ == "__main__":
    ...
    time_stamp = (
        "2020-{}-{}-{}-{}-Release-pre-fedavg-v3".format(current_time[1], current_time[2], current_time[3],
                                                                      current_time[4]))
